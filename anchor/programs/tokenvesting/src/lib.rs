...
declare_id!("GqWdTg8HkKwGfAojQeczHzP8DPXdEmjcimakm3uQXZrp");
...
pub struct CreateVestingAccount<'info> {
    ...
    #[account(init, token::mint = mint , token::authority = treasury_token_account, payer= signer, seeds= [b"vesting_treasury", company_name.as_bytes()], bump)]
    pub treasury_token_account: InterfaceAccount<'info, TokenAccount>,
